defmodule JidoCode.Folio.InboxItem do
  @moduledoc """
  ...
  actions do
    ...
    update :process_to_action do
      ...
      change fn changeset, _context ->
        ...
        case Ash.create(JidoCode.Folio.Action, %{title: title, status: :next}, domain: JidoCode.Folio) do
          {:ok, action} ->
            changeset
    ...
    update :process_to_project do
      ...
      change fn changeset, _context ->
        ...
        case Ash.create(JidoCode.Folio.Project, attrs, domain: JidoCode.Folio) do
          {:ok, project} ->
            changeset
  ...
  relationships do
    belongs_to :created_action, JidoCode.Folio.Action do
      source_attribute :created_action_id
      define_attribute? false
    end

    belongs_to :created_project, JidoCode.Folio.Project do
