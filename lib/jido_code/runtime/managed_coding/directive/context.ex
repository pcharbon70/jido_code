defmodule JidoCode.Runtime.ManagedCoding.Directive.Context do
  @moduledoc "Compile one exact managed coding context manifest."
  alias JidoCode.Runtime.ManagedCoding.Directive.Envelope
  @enforce_keys [:envelope]
  defstruct @enforce_keys
  @spec new(map()) :: {:ok, t()} | {:error, term()}
  def new(attributes), do: wrap(Envelope.new(:context, attributes))
