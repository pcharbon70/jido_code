...
```bash
iex -S mix
iex> JidoCode.GithubIssueBot.CLI.Run.run()
```
...
JidoCode.GithubIssueBot.CLI.Run.run(issue: issue)
```

## Running Tests

```bash
mix test test/jido_code/github_issue_bot/
```
...
test/jido_code/github_issue_bot/
├── issue_run/
