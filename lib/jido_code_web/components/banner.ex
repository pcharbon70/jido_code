defmodule JidoCodeWeb.Components.Banner do
  @moduledoc """
  JidoCodeWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
