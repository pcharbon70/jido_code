defmodule JidoCodeWeb.Components.TextareaField do
  @moduledoc """
  The `JidoCodeWeb.Components.TextareaField` module provides a versatile and customizable textarea field component
