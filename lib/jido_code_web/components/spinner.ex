defmodule JidoCodeWeb.Components.Spinner do
  @moduledoc """
  The `JidoCodeWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `JidoCodeWeb.Components.Spinner` module enables developers to provide
