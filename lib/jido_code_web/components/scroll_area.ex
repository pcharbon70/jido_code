defmodule JidoCodeWeb.Components.ScrollArea do
  @moduledoc """
  The `JidoCodeWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
