defmodule JidoCodeWeb.Components.NativeSelect do
  @moduledoc """
  The `JidoCodeWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `JidoCodeWeb.Components.NativeSelect`
