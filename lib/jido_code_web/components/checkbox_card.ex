defmodule JidoCodeWeb.Components.CheckboxCard do
  @moduledoc """
  The `JidoCodeWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
