defmodule JidoCodeWeb.Components.Overlay do
  @moduledoc """
  The `JidoCodeWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `JidoCodeWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
