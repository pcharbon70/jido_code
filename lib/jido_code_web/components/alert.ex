defmodule JidoCodeWeb.Components.Alert do
  @moduledoc """
  JidoCodeWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
