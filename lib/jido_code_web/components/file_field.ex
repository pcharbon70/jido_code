defmodule JidoCodeWeb.Components.FileField do
  @moduledoc """
  The `JidoCodeWeb.Components.FileField` module provides a versatile and customizable component
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/forms/file-field
  ...
  import JidoCodeWeb.Components.Progress, only: [progress: 1]
