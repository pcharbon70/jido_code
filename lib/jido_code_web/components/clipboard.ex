defmodule JidoCodeWeb.Components.Clipboard do
  @moduledoc """
  The `JidoCodeWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
