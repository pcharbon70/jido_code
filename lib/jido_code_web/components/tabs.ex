defmodule JidoCodeWeb.Components.Tabs do
  @moduledoc """
  `JidoCodeWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/tabs
  ...
  import JidoCodeWeb.Components.Badge, only: [badge: 1]
