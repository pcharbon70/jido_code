defmodule JidoCodeWeb.Components.Menu do
  @moduledoc """
  The `JidoCodeWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `JidoCodeWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  **Documentation:** https://mishka.tools/chelekom/docs/menu
  ...
  import JidoCodeWeb.Components.Button, only: [button_link: 1]
