defmodule AgentJido.Folio.Action do
  @moduledoc """
  ...
  relationships do
    belongs_to :project, AgentJido.Folio.Project do
      allow_nil? true
      public? true
    end

    belongs_to :parent_action, AgentJido.Folio.Action do
      allow_nil? true
      public? true
    end

    has_many :sub_actions, AgentJido.Folio.Action do
