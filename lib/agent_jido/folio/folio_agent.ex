defmodule AgentJido.Folio.FolioAgent do
  @moduledoc """
  ...
  use Jido.AI.ReActAgent,
    ...
    tools: [
      # Inbox
      AgentJido.Folio.InboxItem.Jido.Capture,
      AgentJido.Folio.InboxItem.Jido.ProcessToAction,
      AgentJido.Folio.InboxItem.Jido.ProcessToProject,
      AgentJido.Folio.InboxItem.Jido.Discard,
      AgentJido.Folio.InboxItem.Jido.Inbox,
      # Actions
      AgentJido.Folio.Action.Jido.Create,
      AgentJido.Folio.Action.Jido.Read,
      AgentJido.Folio.Action.Jido.Complete,
      AgentJido.Folio.Action.Jido.MarkWaiting,
      AgentJido.Folio.Action.Jido.DeferSomeday,
      AgentJido.Folio.Action.Jido.MakeNext,
      AgentJido.Folio.Action.Jido.AddSubAction,
      AgentJido.Folio.Action.Jido.Next,
      AgentJido.Folio.Action.Jido.WaitingFor,
      # Projects
      AgentJido.Folio.Project.Jido.Create,
      AgentJido.Folio.Project.Jido.Read,
      AgentJido.Folio.Project.Jido.MarkDone,
      AgentJido.Folio.Project.Jido.DeferSomeday,
      AgentJido.Folio.Project.Jido.Active
    ],
    tool_context: %{
