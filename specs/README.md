...
| **70** | [Rename Plan](70_rename_plan.md) | Draft | agent_jido → jido_code migration |
...
| D2 | Phoenix 1.8 + Ash + PostgreSQL | — | Existing stack from agent_jido |
...
1. **Artifact storage:** First-class diff/patch viewer, or "PR is the artifact"? *(Default: PR is primary, logs stored)*
2. **Issue Bot scope:** Separate workflow type or per-repo configurable "support agent"? *(Default: per-repo support agent)*
