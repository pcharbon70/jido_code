...
- [x] 2 Phase - Deliver one bounded authorized stream coordinator per page/tab.
  ...
  - [x] 2.4 Section - Phase 2 Integration Tests.
    ...
    - [x] 2.4.1 Task {#huid-p02-integration} [repo: jido_code] [after: {#huid-p02-revocation}] - Execute the HUI-D2 admission, capacity, and revocation matrix.
      ...
      - [x] 2.4.1.4 Subtask - Run stream/resource/security/telemetry/proxy smoke suites, `mix precommit`, and clean-checkout CI.

    - [x] 2.4.2 Task {#huid-p02-phase-receipt} [repo: jido_code] [after: {#huid-p02-integration}] - Publish and pin the Phase 2 receipt.
