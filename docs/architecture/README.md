...
- [HUI-B1 source, license, version, and risk receipt](./hypermedia-ui-milestone-b-phase-01-receipt.md)
...
- [HUI-B4 dependency fitness policy](./hypermedia-ui-dependency-fitness-and-update-policy.md)
- [HUI-B4 fitness policy manifest](../../priv/architecture/hypermedia_ui/phase_b4_fitness_policy.json)
- [HUI-B4 release qualification evidence](./hypermedia-ui-release-qualification-evidence.md)
- [HUI-B4 qualification evidence manifest](../../priv/architecture/hypermedia_ui/phase_b4_qualification_evidence.json)
- [HUI-B4 product consumption baseline](./hypermedia-ui-product-consumption-baseline.md)
- [HUI-B4 consumption baseline manifest](../../priv/architecture/hypermedia_ui/phase_b4_consumption_baseline.json)
- [HUI-B4 integration evidence](../../priv/architecture/hypermedia_ui/phase_b4_integration_evidence.json)
- [HUI-B4 qualification receipt](./hypermedia-ui-milestone-b-phase-04-receipt.md)
